export const IllustrationBanner = () => {
  return (
    <div className="max-h-[200px] min-h-[200px] overflow-clip bg-[#09090B] [mask-image:url(/mask-sm.svg)] [mask-position:left_center] [mask-repeat:no-repeat] [mask-size:80%] tablet:[mask-image:url(/mask.svg)] desktop:mt-24 desktop:[mask-size:75%] dark:bg-white">
