...
export const TalkListItem: React.FC<TalkListItemProps> = ({ talk }) => {
  ...
  return (
    <Link to={`/talk/${slugify(talk?.title)}`}>
      <div className="relative h-full rounded-md border border-gray-200 bg-white px-3 py-4 hover:border-gray-800 hover:transition-[3s] laptop:px-6 laptop:pb-8 laptop:pt-6 dark:border-zinc-800 dark:bg-zinc-800 dark:hover:bg-zinc-700">
